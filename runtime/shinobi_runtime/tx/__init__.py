...
__all__ = [
    "AtomicManifestPersister", "FileMutation", "GitStager", "GitRemoteDurability",
    "IdempotencyReceipt", "ReceiptStore", "SingleWriterLock", "TransactionManifest",
    "TransactionCoordinator", "TransactionExecution", "RecoveryDecision", "RemoteSnapshot",
    "TransactionPlanner", "WriteAheadLog", "canonical_json_bytes", "canonical_sha256",
    "sha256_bytes",
]
...
_EXPORT_MODULES = {
    ...
    "TransactionCoordinator": ".campaign_coordinator",
