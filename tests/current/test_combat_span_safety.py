...
def test_rapid_lethal_target_prefers_nearest_lawful_active_enemy_after_base_observation_refresh():
    ...
    def base_selector(**kwargs):
        # Stand in for exact combat's lawful perception refresh. Generic tactical
