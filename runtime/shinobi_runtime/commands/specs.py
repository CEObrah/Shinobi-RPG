...
COMMAND_SPECS={
 ...
 "jianghu_contract_resolution":CommandSpec(("action","contract_ref","participant_refs"),(),"Accept or start a funded Jianghu contract. Escort starts form their exact field party from accepted principals plus any active lawful standing retinue.",{},variants={"accept":_v(("action","contract_ref","participant_refs")),"start":_v(("action","contract_ref"))}),
