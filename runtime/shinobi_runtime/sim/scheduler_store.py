...
LEGACY_SCHEMA = "causal-scheduler-registry"
...
def legacy_to_shards(record: Mapping[str, Any]) -> Dict[str, bytes]:
    """Convert one legacy consolidated scheduler record into sharded after-images."""
