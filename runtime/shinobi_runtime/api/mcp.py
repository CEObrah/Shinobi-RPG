    ...
    *,
    ...
    server = MCPServer(
        ...
        instructions=(
            ...
            "player-visible returned facts and typed reads. Preview one supported "
            "command, then pass the exact returned command object and preview "
            "attestation to execute_command. "
            "Narrate persistence only after a committed or duplicate receipt. Refresh "
            "context after writes or stale revisions. OOC audit is read-only. Unsupported "
            "intent fails closed; never substitute chat memory, model canon recall, or prose."
        ),
        version="0.2.0",
    ...
    @server.tool(
        ...
        description=(
            ...
            "player summary, exact revision/time, permitted IDs, and supported commands."
        ),
    ...
    @server.tool(
        ...
        description=(
            ...
            "semantic command advertised by fresh play context. Use this after selecting intent "
            "and before preview; do not bulk-load every command contract."
        ),
        annotations=read_annotations,
        meta=read_security_meta,
        structured_output=True,
    ...
    @server.tool(
        ...
        description=(
            "Read-only preview of one supported semantic command at an exact revision. "
