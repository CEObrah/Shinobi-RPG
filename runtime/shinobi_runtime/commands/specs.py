...
COMMAND_SPECS={
 ...
 "jianghu_retinue_resolution":CommandSpec(("action","retinue_ref","chooser_refs","requested_count"),(),"Request or release Wei's persistent three-person travel team under one or more authorized choosers. The standing team reserves no mission hours by itself and is distinct from temporary contract staffing.",{},variants={"request":_v(("action","retinue_ref","chooser_refs","requested_count")),"release":_v(("action","retinue_ref"))}),
