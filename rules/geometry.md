...
Numerical timing authority lives in `data/mechanics/timing.json`; body reach and mass authority lives in `data/mechanics/body.json`; technique geometry lives in the technique and effect registries.
