...
_MAX_ACTIVE_MISSIONS = 8
_MAX_TEAM_HISTORY_EVENTS = 24
_MAX_REPORT_HISTORY = 32
_MAX_RELATIONSHIP_UPDATES = 56
...
__all__ = [
    ...
    "DEVELOPMENT_BANK_PATH", "INFORMATION_REGISTRY_PATH", "INVENTORY_REGISTRY_PATH",
    ...
    "_TEAM_HISTORY_ROOT", "_FACTION_MEMORY_ROOT", "_MAX_ACTIVE_MISSIONS",
    "_MAX_TEAM_HISTORY_EVENTS", "_MAX_REPORT_HISTORY", "_MAX_RELATIONSHIP_UPDATES",
