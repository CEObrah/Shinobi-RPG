...
ROUTES = (
    ...
    (("state/force/", "check_force_population_conservation.py", "population_pool_id"), {
        "tests/runtime/test_country_force_population_conservation.py",
        "tests/runtime/test_release_representation_bridge.py",
    }),
    ...
    (("mission", "operational-world", "economies-and-mission-markets", "living_world_operations.py"), {
    ...
    (("route_access.py", "routes-and-settlements", "world_location_hierarchy", "check_world_geography.py"), {
        "tests/runtime/test_route_discovery.py",
        "tests/runtime/test_route_knowledge_access.py",
        "tests/runtime/test_world_location_hierarchy.py",
    }),
