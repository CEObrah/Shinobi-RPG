...
# Some terminal/interrupted route states still own bodies even though they must
# not be advanced by the scheduler. Keeping presence ownership separate prevents
# a stopped traveler from falling through to a stale settlement location.
ROUTE_PRESENCE_STATUSES = frozenset({*ROUTE_SERVICE_STATUSES, "stranded"})
