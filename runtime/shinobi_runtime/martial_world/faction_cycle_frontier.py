    ...
    *,
    ...
    for event in events:
        ...
        if dead_refs:
            ...
            if monthly_succession_ref and (fid == "house_tang" or monthly_succession_ref == player_ref):
                # Succession is objective faction truth, not omniscient player
                # knowledge.  Direct delivery is reserved for Wei's own House or
                # the exceptional case where Wei himself is the successor.
