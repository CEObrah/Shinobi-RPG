# Shinobi Family, Marriage, Household, and Succession
...
## Shinobi setting overlay

Clan/village law, secret-technique custody, bloodline security, classified service and household security may affect legality and political consequences. They never grant a clan or village authority that its saved charter/law does not actually possess. Lineage eligibility is not automatic jutsu/bloodline capability; awakening and training remain in their own mechanics. Children enter civilian/Academy/training systems only through actual age, enrollment, access and time.
