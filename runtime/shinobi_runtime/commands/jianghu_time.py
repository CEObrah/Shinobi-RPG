...
class JianghuTimeCommandsMixin:
    ...
    def _safe_lodging_practice(
        ...
        *,
        ...
        if hours <= 0:
            return {}
        _actor_path, _actor_roster, _actor_ordinal, actor = roster_person(self.repository, player_id)
        site_ref = self._time_effective_person_location(player_id, actor)
        try:
        ...
        for ref, role in candidates:
            ...
            try:
                ...
                continue
            if self._time_effective_person_location(ref, person) != site_ref:
                continue
