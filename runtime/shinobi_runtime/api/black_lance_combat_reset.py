...
identity that recognizes the exact bad revision-107 state tree plus the existing
...
BLACK_LANCE_COMBAT_RESET_ANCHOR = "jianghu.black_lance.fullfresh_r107_repair.v2"
...
_BAD_REVISION = 107
_BAD_TIME = "SE-0061-09-27T21:22:10"
_BAD_STATE_SHA256 = "6af9c1b3b7fe67db2bca2a0af1838db3c3ee970adcd4c48a4c91fe788133a82f"
...
def build_black_lance_combat_reset(*, repository: Any, expected_revision: int) -> BlackLanceResetBuild:
    ...
    result = {
        ...
        "provenance_source": "exact_r107_state_digest_plus_certified_r97_release_contract",
    }
