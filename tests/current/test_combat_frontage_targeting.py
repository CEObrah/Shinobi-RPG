...
def test_frontage_planner_is_canonical_not_bootstrap_monkey_patch() -> None:
    ...
    # Exact combat statically imports the canonical team planner. Production
    # installation must not replace it at import/bootstrap time.
    assert exact_combat.plan_team_exchange is team_tactics.plan_team_exchange
    assert getattr(exact_combat.plan_team_exchange, "_frontage_targeting", False) is False
