...
def _class_policy(class_name: str) -> dict[str, Any]:
    ...
    return {
        ...
        "requires_gm_judgment": bool(row.get("requires_gm_judgment")),
    }
...
def classify_handoff(event: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if event.get("requires_gm_judgment") is True or kind in _event_kind_set("gm_judgment"):
        return _class_policy("gm_judgment")
