...
class StrategicCommandsMixin:
    def _formation_movement_resolution(
        ...
        event_id = self._append_semantic_event(
            ...
            affected_owner_refs=tuple(sorted((formation_path, *person_writes))),
    ...
    def _conflict_resolution(
        ...
        if action == "start":
            ...
            bases=[]
            for side in sides:
                try: bases.append(owner_authority(side))
                except CommandRejectedError: pass
            if not bases:
                raise CommandRejectedError("conflict_authority_denied")
            ...
            records[conflict_ref] = {
                ...
                "ceasefire_consents": [], "end_consents": [], "fronts": {},
            }
