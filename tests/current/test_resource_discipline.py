...
def _delegated_offscreen_policy(*, targeting_intent: str = "lethal") -> dict:
    return {
        "decision_origin": "player_delegated",
        "engagement_intent": "bounded_delegated_combat",
...
def test_delegated_bounded_simulation_uses_wei_resource_doctrine_instead_of_treating_driver_as_manual():
    ...
    routine = simulate_exact_combat(
        ...
        authored_combat_policy=_delegated_offscreen_policy(),
    )
