...
- Skill/rebaseline changed-path selector: PASS, 181 passed in 14.98s.
- Focused rebaseline/scene/combat-parley batch: PASS, 15 tests.
- Earlier full changed-owner rebaseline/scene/state batch: PASS, 196 tests.
