...
def test_adaptive_movement_is_scoped_as_canonical_input_to_one_internal_exchange():
    captured = {}

    def resolver(**kwargs):
        captured.update(kwargs)
        assert kwargs.get("_adaptive_movement_intent") is None
        assert kwargs.get("movement_intent") == "lateral"
        return {"ok": True}
    ...
    assert captured["movement_intent"] == "lateral"
