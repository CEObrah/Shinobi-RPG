...
# Canonical control plane. Root-level duplicate manuals are intentionally retired.
control_files=[
    ...
    'runtime/contracts/temporal-settlement.json',
    'runtime/contracts/autonomous-world-simulation.json',
]
for f in control_files:
    if not (ROOT/f).exists(): err(f'missing_runtime_file:{f}')
for f in ['RUNTIME.md','VOICE.md','REPOSITORY_MAP.md','P'+'LAY.md','PROTO'+'COL.md']:
...
for req in ['plugins/shinobi-rpg/skills/shinobi-game-master/SKILL.md','plugins/shinobi-rpg/skills/shinobi-game-master/references/narration.md','plugins/shinobi-rpg/skills/shinobi-game-master/references/runtime-architecture.md','runtime/contracts/repository-map.json','state/meta.json','state/player.json','state/scene.json']:
