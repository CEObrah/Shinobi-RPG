...
def test_retinue_uses_four_sector_back_to_back_when_outnumbered():
    ...
    assert all(plan['assignments'][ref]['preferred_action'] == 'hold' for ref in ('jiang', 'han', 'fu'))
...
def test_retinue_template_values_are_behavior_authority_not_trace_only():
    ...
    assert all(plan['assignments'][ref]['preferred_action'] == 'attack' for ref in ('jiang', 'han', 'fu'))
