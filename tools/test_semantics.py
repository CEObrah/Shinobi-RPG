...
# Canonical human map must explain bounded read/write and materialization behavior.
hmap=(R/'plugins/shinobi-rpg/skills/shinobi-game-master/references/repository-map.md').read_text(encoding='utf-8')
for phrase in ('Minimum-context development routes','For formation operations','For a returning cold person','Large battle workflow'):
