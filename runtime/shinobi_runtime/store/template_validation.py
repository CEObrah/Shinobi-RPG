        ...
        while stack:
            ...
            if isinstance(current, dict):
                ...
                if mode == "closed":
                    ...
                    # JSON-Schema objects with additionalProperties=true may
                    # legitimately carry heterogeneous event-specific payloads.
                    # The schema/domain validators own those free-form child
                    # fields; the structural template only proves that this
                    # pointer is intentionally open rather than accidentally
                    # unregistered.
                    continue
                else:
