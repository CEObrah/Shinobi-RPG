...
This repository is self-contained. Never load or import Sword & Banners state, rules, data, runtime code, or Skill content.
...
Treat real play as integration testing for narration, dialogue, combat, pacing, balance, UX, continuity, economy, teams, missions, training, institutions, family, information, autonomy, and simulation depth. Treat a mechanically valid but persistently story-starved world as a real integration failure when lawful causal pressure exists but cannot bootstrap, propagate, or reach the player.
