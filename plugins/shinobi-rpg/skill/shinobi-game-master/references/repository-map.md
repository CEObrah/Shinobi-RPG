...
GM-director rule: exact established present people may expose bounded private character/cognition truth before a conversation session, and exact combat may expose private encounter causality. These projections help the AI direct coherent initiative and dialogue but are not player knowledge and have no mechanical-consequence authority.
