...
from shinobi_runtime.martial_world.exact_combat import combat_default_targeting_intent, currently_visible_enemies, default_action_for, default_target_for, default_weapon_for_action, improvised_weapon_state_from_scene, initialize_combat, resolve_exchange, attempt_disengage
...
def _resolve_player_combat_span(
    *, combat: Mapping[str, Any], people: Mapping[str, Mapping[str, Any]],
    ...
    ordinary=[row for row in narrative_beats if row.get('salience')!='protected'][-12:]
