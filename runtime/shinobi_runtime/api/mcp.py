...
def create_mcp_server(
    ...
    *,
    ...
    @server.tool(
        ...
        description=(
            "Required first call for live play. Returns a bounded player-visible scene, "
            "player summary, exact revision/time, permitted IDs, a scene-first GM writer workspace with active-scene direction, and compact mechanic families. "
