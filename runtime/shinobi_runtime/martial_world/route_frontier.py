...
from .escort_living_world import (
    ...
    interception_force_size, observed_escort_strength, principal_ransom_value_cash, private_interception_decision_context,
        ...
        def _start_settlement_exposure_pursuits(
            ...
            for candidate in list(local_factions_by_place.get(stop_place,[])):
                ...
                movements[pursuit_ref]={
                    ...
                    "ready_at":(at+timedelta(hours=ready_hours)).isoformat(),"status":"pursuing",
