...
from .route_activity import route_controlling_refs
...
def settle_shared_frontier(
    *,
    ...
    def load_roster(fid: str) -> tuple[str, dict[str, Any]]:
        ...
        index = commitments_state.get("person_index", {}) if isinstance(commitments_state, Mapping) else {}
        busy = {str(ref) for ref in index} if isinstance(index, Mapping) else set()
