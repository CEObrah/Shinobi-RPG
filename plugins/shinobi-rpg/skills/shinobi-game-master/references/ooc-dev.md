...
GitHub Actions is development QA, never campaign/mechanical authority, and normal gameplay never polls it. After merge, verify Railway source-head/deployment sync and the smallest safe live smoke path before treating production as updated. Live play/playtesting then remains the final integration layer.
