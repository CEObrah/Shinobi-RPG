...
simulation hardening, physiology projection parity, and resolved-route-contact
reconciliation. Historical repair implementations remain available for forensic
tests, but one-time campaign repair anchors are not installed into normal
...
def create_app_from_env():
    ...
    class RouteReconciledCampaignOperations(PhysiologyProjectedCampaignOperations):
