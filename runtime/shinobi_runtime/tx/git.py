...
TRANSACTION_TRAILER = "Shinobi-Transaction"
CAMPAIGN_TRAILER = "Shinobi-Campaign"
REVISION_TRAILER = "Shinobi-World-Revision"
MODE_TRAILER = "Shinobi-Mode"
REQUEST_TRAILER = "Shinobi-Request"
COMMAND_DIGEST_TRAILER = "Shinobi-Command-Digest"
...
class GitStager:
    ...
    def _commit_message(cls, manifest: TransactionManifest) -> str:
        lines = [
            "shinobi: %s transaction %s" % (manifest.mode, manifest.transaction_id),
            "",
        ]
        lines.extend(
            "%s: %s" % (key, value)
