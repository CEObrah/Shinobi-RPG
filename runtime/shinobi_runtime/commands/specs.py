...
COMMAND_SPECS={
 ...
 "jianghu_contract_resolution":CommandSpec(("action","contract_ref","participant_refs"),(),"Legacy shipment-contract compatibility surface.",{},variants={"accept":_v(("action","contract_ref","participant_refs")),"start":_v(("action","contract_ref"))}),
 "jianghu_escort_resolution":CommandSpec(("action","contract_ref","escort_refs"),(),"Accept or start a funded cargo, person, or mixed escort contract using exact martial escorts and any active standing retinue.",{},variants={"accept":_v(("action","contract_ref","escort_refs")),"start":_v(("action","contract_ref"))}),
 ...
 "jianghu_retinue_resolution":CommandSpec(("action","retinue_ref","chooser_refs","requested_count"),(),"Request or release a persistent zero-time personal field retinue under one or more authorized choosers without reserving mission hours.",{},variants={"request":_v(("action","retinue_ref","chooser_refs","requested_count")),"release":_v(("action","retinue_ref"))}),
