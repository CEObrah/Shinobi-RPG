    ...
    *,
    ...
    projected["scene_vitality"] = {
        ...
        "scope": (
            ...
            "place, time, and cast. A nearby established person may enter or leave the immediate interaction "
            "when spatially plausible. These presentation choices must not create or settle durable game facts."
        ),
