...
class CommitmentForceCommandsMixin:
    ...
    def _commitment_transition(
        ...
        def validate(overlay: StagedOverlay, manifest: TransactionManifest) -> None:
            ...
            scheduler_record = self._scheduler_from_reader(overlay)
