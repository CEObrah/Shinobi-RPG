"""Machine-readable invalidation of explicitly repaired gameplay transactions."""
...
def load_transaction_invalidations(repository) -> Tuple[TransactionInvalidation, ...]:
    ...
    if (
        ...
        or record.get("schema") != "shinobi.transaction-invalidations"
    ...
    for raw in rows:
        ...
        if (
            ...
            or transaction_id != "tx.gameplay." + request_digest
...
def command_matches_invalidated_request(
    ...
    """Prevent an invalidated external request ID from ever being replayed."""
