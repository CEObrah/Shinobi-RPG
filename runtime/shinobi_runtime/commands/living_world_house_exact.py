            ...
            for member_ref in members:
                ...
                for target in targets:
                    ...
                    if record.get("schema") == "person":
                        ...
                        leaf, starting_value = parts[1], container[parts[1]]
                    else:
                ...
                touched_bank = True
                results.append({"member_ref": member_ref, "cohort_id": cohort.get("id"), "from": str(prior), "through": str(through), "active_hours": str(active_hours), "outcomes": outcomes})
        if touched_bank:
