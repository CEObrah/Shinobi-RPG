...
def test_play_context_command_surface_is_demand_loaded_not_full_schema_dump():
    ...
    assert compact['commands']['supported_command_types']==['advance_time','jianghu_training_focus_resolution']
    assert compact['commands']['intent_domains']['time']==['advance_time']
    assert compact['commands']['intent_domains']['training']==['jianghu_training_focus_resolution']
    assert compact['commands']['contract_lookup'].startswith('Call get_command_contract')
