...
from shinobi_runtime.tx.remote import GitRemoteDurability
...
class TransactionCoordinator:
    ...
    def _assert_recovery_paths_are_bounded(
        ...
        # machinery, not unrelated campaign mutation. Remove it only when the
        # exact WAL manifest owns the implied target and the bytes match one of
        # that mutation's proven before/after images.
    ...
    def _remote_for_wal(
        ...
        # Enabling required durability after a local-only WAL was written is
