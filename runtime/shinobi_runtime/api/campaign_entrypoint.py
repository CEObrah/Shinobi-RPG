...
def create_app_from_env():
    ...
    from shinobi_runtime.api.campaign_growth_discovery import RouteAwareCampaignOperations
    ...
    from shinobi_runtime.commands.campaign_house_intake import CampaignCommandPlanner
