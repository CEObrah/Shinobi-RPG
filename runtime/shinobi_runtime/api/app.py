...
class ServiceSettings:
    ...
    def from_env(cls, repository: RepositoryStore) -> "ServiceSettings":
        # ChatGPT authenticates the MCP surface through OAuth.  This legacy
        # REST token is optional; when absent, an unreported per-process value
        # leaves the compatibility routes effectively disabled.
