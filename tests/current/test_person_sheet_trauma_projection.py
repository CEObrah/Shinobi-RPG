...
def test_person_sheet_resolver_uses_canonical_health_projection(monkeypatch):
    """The public person-sheet projection must use the canonical live health rules."""
