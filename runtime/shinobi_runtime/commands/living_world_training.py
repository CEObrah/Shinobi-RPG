...
class LivingWorldTrainingMixin:
    ...
    def _eligible_autonomous_group(
        ...
        *,
        ...
        best: Optional[Tuple[str, Mapping[str, Any], str, list[Tuple[str, str, Dict[str, Any]]]]] = None
    ...
    def _apply_autonomous_team_training(
        ...
        *,
        ...
        if group is None:
            return {"skipped": "no_nonplayer_instructor_and_colocated_group"}
        instructor_ref, instructor_record, location_ref, member_rows = group
        ...
        for member_ref, member_path, record in member_rows:
            ...
            if entry is not None:
                ...
                if cursor > interval_start:
                    cursor_skips[member_ref] = "development_window_already_partially_settled"
                    continue
        ...
        for member_ref, _member_path, record in eligible_rows:
            ...
            if not candidates:
                ...
                continue
            start_index = _stable_roll(team_id, member_ref, interval_start, modulo=len(candidates))
