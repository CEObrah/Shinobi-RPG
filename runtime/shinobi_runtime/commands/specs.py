...
COMMAND_SPECS = {
    ...
    "security_network_resolution": _spec(
        ("action","sector_ref","owner_ref","place_ref","route_refs","stock_ref","classification","axis","subject_ref","evidence_ref","recipient_refs","alarm_ref"),
        "Establish resource-backed security sectors, improve them from evidence, and route evidence-backed alarms to explicit recipients.",
        variants={
            "establish_sector": _variant(("action","sector_ref","owner_ref","place_ref","route_refs","stock_ref","classification")),
