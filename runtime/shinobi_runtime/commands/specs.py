...
COMMAND_SPECS={
 ...
 "jianghu_retinue_resolution":CommandSpec(("action","retinue_ref","chooser_ref","requested_count"),(),"Request or release a persistent zero-time personal field retinue without reserving mission hours.",{},variants={"request":_v(("action","retinue_ref","chooser_ref","requested_count")),"release":_v(("action","retinue_ref"))}),
