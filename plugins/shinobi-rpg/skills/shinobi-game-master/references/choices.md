...
7. Do not re-offer completed setup
8. Keep implementation state out of IC choices
9. Distinguish world availability from implementation blockage
10. Show time when useful
11. Keep options concise
12. Format
