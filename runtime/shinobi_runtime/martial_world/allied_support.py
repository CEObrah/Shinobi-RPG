...
def stage_defensive_calls_to_arms(
    *, read_json: Callable[[str], Any], writes: dict[str, Any], deployments: dict[str, Any], schedule: Mapping[str, Any],
    ...
    busy = (set(str(x) for x in commitments.get("person_index", {}) if isinstance(x, str)) if isinstance(commitments.get("person_index"), Mapping) else set()) | physical_unavailable_person_refs(view)
