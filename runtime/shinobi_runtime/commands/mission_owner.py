...
_SUBJECT_KINDS = frozenset(("person", "asset", "place", "information", "force", "formation", "route", "institution", "faction", "population", "project", "case"))
...
class MissionBrief:
    ...
    def __post_init__(self) -> None:
        ...
        if self.subject_kind not in _SUBJECT_KINDS:
            raise ValueError("subject_kind is not a supported mission subject type")
