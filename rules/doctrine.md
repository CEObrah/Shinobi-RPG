...
Permanent doctrine is versioned. A doctrine change creates a new version and a doctrine-familiarity value. Units do not instantly execute a new doctrine perfectly.

Doctrinal reforms require decision, dissemination, instructor preparation, drills, equipment where needed, time, and familiarization.
...
At battle start, snapshot doctrine version, doctrine familiarity, tendencies, commander, posture, orders, stats, equipment, morale, cohesion, fatigue, supply, terrain, and known intelligence. Resolve from that snapshot.

## Shinobi tendency extensions

Shinobi teams and units may additionally track chakra conservation, capture bias, information preservation, and stealth bias. These remain habitual execution tendencies, not automatic orders and not personality replacements.
