...
def test_planner_mro_keeps_development_overlay_active():
    assert RepositoryCommandPlanner.__mro__[1] is JianghuInstitutionalCommandsMixin
    assert RepositoryCommandPlanner.__mro__.index(JianghuDevelopmentCommandsMixin) == 2
