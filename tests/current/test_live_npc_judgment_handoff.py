...
def test_current_active_combat_builds_complete_gm_npc_judgment_frontier() -> None:
    ...
    This intentionally exercises the same canonical owners used by
    CampaignOperations.play_context so a swallowed projection failure cannot
    leave live ChatGPT unable to author the next exact-combat decision frontier.
    """
