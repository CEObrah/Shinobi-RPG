...
This module intentionally has no dependency on the optional MCP transport
package.  The MCP server imports these exact helpers, while core transaction
security tests can run in environments that do not install the transport.
"""
